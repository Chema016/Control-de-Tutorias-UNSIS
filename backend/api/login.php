...
if (strcasecmp($email, ADMIN_EMAIL) === 0) {
    if (password_verify($password, ADMIN_PASSWORD_HASH)) {
        login_admin();
        echo json_encode(['error' => false, 'role' => 'admin', 'redirect' => '/frontend/admin/dashboard.php']);
        exit;
    }
...
echo json_encode(['error' => false, 'role' => 'profesor', 'redirect' => '/frontend/tutor/dashboard.php']);
