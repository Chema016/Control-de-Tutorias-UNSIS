...
<div class="app">
  ...
  <div class="main">
    ...
    <div class="card">
      ...
      <p>
        <a href="/frontend/admin/profesores.php" class="btn">+ Registrar nuevo profesor/tutor</a>
        &nbsp;
        <a href="/frontend/admin/alumnos.php" class="btn btn-secundario">+ Registrar nuevo alumno</a>
      </p>
    </div>
